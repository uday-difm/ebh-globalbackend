...
const Button = ({
  ...
  const buttonContent = (
    <div className={`relative group overflow-hidden rounded-full cursor-pointer ${className}`}>
      ...
      <div className={`absolute w-[280px] h-[200px] ${animatedColor2} transform rotate-[120deg] transition-all duration-800 ease-in-out top-[-120%] left-[100%] group-hover:left-[20%] z-10`}></div>
      <button
        type={type}
