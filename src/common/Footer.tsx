          ...
          <div>
            ...
            <div className="flecx flex-col items-center mt-4">
              <input
                ...
                required
                className="w-full px-3 py-2 mb-8 text-sm bg-gray-100 border border-gray-300 rounded-md mb-2 focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              <div
              ...
              >
                ...
                <div className="absolute inset-0 bg-green-500 z-0 transition-opacity duration-500 group-hover:opacity-0 rounded-full"></div>

                {/* Animated Blue Layers on Hover */}
                <div className="absolute w-[100px] h-[200px] bg-blue-700 transform rotate-[35deg] transition-all duration-500 ease-in-out top-[-245%] left-[-90%] group-hover:left-0 z-10"></div>
                <div className="absolute w-[200px] h-[90px] bg-blue-700 transform rotate-[125deg] transition-all duration-500 ease-in-out top-[-15%] left-[100%] group-hover:left-[20%] z-10"></div>
