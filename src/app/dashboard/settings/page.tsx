...
const SettingsPage: React.FC = () => {
    const [photo, setPhoto] = useState<string | null>(null); // photo can be a string URL or null
    ...
    const handlePhotoUpload = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            setPhoto(URL.createObjectURL(file)); // Create an object URL for the uploaded image
        }
    };

    const handleCancel = () => {
    // Handle cancel logic here (e.g., reset form data or close modal)
  ...
  const handleSave = () => {
    // Handle save logic here (e.g., save the form data)
    console.log("Save clicked", formData);
    // You can send data to an API or update the state here
  };

    return (
        <DashboardLayout>
            <Head>
                <title>Settings - World Model Hunt</title>
                    ...
                    <div className="flex-shrink-0 w-full max-w-sm mx-auto bg-white shadow-lg rounded-lg p-8 space-y-6">
                        ...
                        <div className="flex justify-center mb-6">
                            <div
                                ...
                                style={{ backgroundImage: `url(${photo || 'https://via.placeholder.com/150'})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
                            >
                        ...
                        <div className="flex justify-center gap-[9px] mb-6">
                            <button
                                ...
                                onClick={() => setPhoto(null)} // Handle photo delete action
                            >
                                Delete
                            </button>
                            <button
                            ...
                            <div className="flex justify-center items-center mb-4">
                                ...
                                <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 text-blue-600">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7-7-7 7M12 2v18"></path>
                                    </svg>
                                </div>
                            </div>
