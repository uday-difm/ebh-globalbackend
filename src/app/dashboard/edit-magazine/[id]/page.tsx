...
export default function EditMagazinePage() {
    ...
    useEffect(() => {
        ...
        const fetchMagazine = async () => {
            try {
                const res = await fetch(`/api/dashboard/magazine/view-magazine?id=${id}`);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formData.append('magazineTitle', form.magazineTitle);
        formData.append('slug', form.magazineSlug);
        formData.append('tags', form.tags);
        formData.append('date', form.date);
        formData.append('category', form.category);
        formData.append('MagCloudLink', form.MagCloudLink);
        formData.append('PdfLink', form.PdfLink);
        formData.append('description', form.description);
        formData.append('age_verification_required', form.age_verification_required ? '1' : '0');
        formData.append('email_verification_required', form.email_verification_required ? '1' : '0');
        ...
        const res = await fetch('/api/dashboard/magazine/update-magazine', {
            method: 'PUT',
            body: formData,
        });
                        ...
                        <div className="p-6 space-y-8 text-gray-600 ">
                            ...
                            <div className="flex flex-col gap-4">
                                <div>
                                    <input
                                        type="checkbox"
                                        checked={form.age_verification_required}
                                        onChange={() =>
                                            setForm({ ...form, age_verification_required: !form.age_verification_required })
                                        }
                                        className="mr-2"
                                    />
                                    <label className="text-black dark:text-white">Age Verification Required</label>
                                </div>
                                <div>
                                    <input
                                        type="checkbox"
                                        ...
                                        onChange={() =>
                                            setForm({ ...form, email_verification_required: !form.email_verification_required })
                                        }
                                        className="mr-2"
                                    />
                                    <label className="text-black dark:text-white">Email Verification Required</label>
                                </div>
                            </div>
