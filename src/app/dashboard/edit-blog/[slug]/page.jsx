...
export default function EditBlogPage() {
    ...
    const [form, setForm] = useState({
        ...
        blogSlug: '',
        description: '',
        content: '', // Keep a copy of the content in the main form state
    });
    ...
    // Use useMemo to prevent editor config from causing re-renders
        ...
        const fetchBlog = async () => {
            try {
                ...
                setForm({
                    ...
                    content: blogData.blog_content || '', // This is the content that goes into the editor
                });
    ...
    const handleImageChange = (e) => {
        // ... (your existing image change logic is fine)
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="p-6 space-y-8">
                            ...
                            <div>
                                ...
                                <JoditEditor
                                    ref={editorRef}
                                    value={form.content} // Correctly bind to the form state
                                    config={editorConfig}
                                    onChange={(newContent) => setForm({ ...form, content: newContent })} // Use onChange to update state
                                />
                            </div>
