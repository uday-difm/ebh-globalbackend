...
// ------------------ Magazine Client Component ------------------
export default function MagazineClient({ initialMagazines = [] }) {
        ...
        <div className="container mx-auto mt-10 pt-20 pb-10 max-w-[1350px]">
          <div className="flex flex-col items-center gap-10 lg:px-[10%]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
              {initialMagazines.slice(0, visibleCount).map((data, index) => (
            ...
            {visibleCount < initialMagazines.length && (
